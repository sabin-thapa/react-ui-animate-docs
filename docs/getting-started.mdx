...
After installation you are ready to implement your own gestures and animation on your project. Let's write a simple demo where an elements left property is animated from 0 to 500 when we click a button:
...
import { Example } from '@site/src/components/GettingStartedExamples';
